  ...
  function defaultDisplay() {
    ...
    if (historyCities != undefined) {
      ...
      function showPosition(position) {
        ...
        queryURL = "https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + lon + "&appid=17ffeabcb0395a48b5f63a70619d8c8e";
        $.ajax({
          url: queryURL,
          method: "GET"
        })
        ...
        secondQueryURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&appid=17ffeabcb0395a48b5f63a70619d8c8e";
        $.ajax({
          url: secondQueryURL,
          method: "GET"
        })
